...
\begin{document}
    ...
    \newsectionspace
    \experience{Mai 2026}{Août 2026}{Ministère de l'Intérieur}{Data Engineer}{Paris, FR}{
        \textit{Contexte :}
        Le \textbf{Ministère de l'Intérieur} est une institution centrale de l'État français, responsable de la sécurité intérieure, de l'administration du territoire et de la gestion des collectivités locales.

        Conception et mise en œuvre d'une architecture \textbf{Data Lakehouse} pour centraliser, structurer et valoriser les données du ministère.

        \begin{itemize}[nosep, leftmargin=*]
            \item Conception de l'architecture Data Lakehouse (couches bronze, silver, gold)
            \item Ingestion et transformation des données depuis des sources hétérogènes
            \item Orchestration des pipelines de données
            \item Mise en place de la gouvernance des données et du catalogue de données
            \item Optimisation des performances de requêtage et du stockage
            \item Création de dashboards analytiques pour les directions métier
        \end{itemize}
    }

    \newsectionspace
    \experience{Sept. 2025}{Mai 2026}{Waiyer}{Auto entrepreneur}{Paris, FR}{
        \textit{Contexte :}
    ...
    \newsectionspace
    \education{Nov. 2026}{Déc. 2027}{Institut Polytechnique de Paris (École Polytechnique)}{Palaiseau, FR}
    \par\noindent\hspace*{\firstcolwidth}\hspace*{1.5em}\footnotesize{Executive MSc in Cybersecurity — Spécialisation : Architecte de la Sécurité}

    \newsectionspace
    \education{Sep. 2018}{Juin 2021}{ESILV (École Supérieure d'Ingénieurs Léonard De Vinci)}{Courbevoie, FR}
    \par\noindent\hspace*{\firstcolwidth}\hspace*{1.5em}\footnotesize{Master en Informatique, Big Data et Objets Connectés - Spécialisation en Data Science}

    \newsectionspace
    \education{Sep. 2019}{Jan. 2020}{UCR (University Of California Riverside)}{Riverside, CA, USA}
    \par\noindent\hspace*{\firstcolwidth}\hspace*{1.5em}\footnotesize{Data Mining Techniques (CS 235), Machine Learning (CS 171), Python programming (CS 009)}

    \newsectionspace
    \education{Sep. 2016}{Déc. 2018}{CPGE Fénelon Sainte-Marie}{Paris, FR}
    \par\noindent\hspace*{\firstcolwidth}\hspace*{1.5em}\footnotesize{MPSI / MP (Classe Préparatoire aux Grandes Écoles)}
