...
\begin{document}
    ...
    \newsectionspace
    \experience{Avr. 2025}{\textit{présent}}{LCL [SFEIR]}{Data Architect}{Villejuif, FR}{
        \textit{Contexte :}
        ...
        Optimisation de l’organisation interne de l’entité SNI et mise en place des tableaux de bord analytiques pour son CODIR et autres leaders de squads. L’enjeu était de consolider les données issues de différentes sources, orchestrer et automatiser leur traitement via une architecture scalable et maintenable.
    ...
    \newsectionspace
    \experience{Mar. 2023}{présent}{SFEIR}{Data Consultant}{Neuilly Sur Seine, FR}{
        \textit{Contexte :}
        ...
        \begin{itemize}
            \item \textbf{Recrutements} de profils techniques Data Engineers - Data Scientists - ML Ops - Devops - Fullstack
